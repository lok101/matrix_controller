...
@dataclass
class FakeBatchCoordinator(BatchDeployCoordinatorPort):
    results: list[tuple[str, int, int]] = field(default_factory=list)
    calls: list[list[MatrixDeployItem]] = field(default_factory=list)
